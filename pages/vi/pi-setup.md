...
**NOTE:** If you run into any issues with flashing, try and update Etcher. You can also try [Rufus]( https://rufus.ie/) (Windows) or [Raspberry Pi Imager](https://www.raspberrypi.org/downloads/).

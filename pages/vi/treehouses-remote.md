...
**NOTE:** To add a password to the treehouses hotspot, enter the command exactly as above but being sure to add a custom hotspot password after your wifi password.

...
reboot
```
Now, save the file, and safely eject the SD card.  


### Step 2 - Start up your Raspberry Pi

Plug the microSD into your Raspberry Pi, plug in your Ethernet cable if you are using it, and power it on.  The red LED should turn on, indicating that the Raspberry Pi is connected to power.
